...
/* Define username and associated password array */$logins = array('Aresos' => 'Landon12()','username1' => 'password1','username2' => 'password2');
...
<h2 style="color:white;"> Aresos | Login </h2>
  <div class="form">
    ...
    <?php } ?>
      ...
      <p class="message">© Copyright 2020 Aresos  <a href="SurfFreely.html" style="color:black;">Forgot Password?</a></p></a></p>
    </form>
  </div>
</div>
<style>
...
body {
  background: #494949; /* fallback for old browsers */
  font-family: "Roboto", sans-serif;
